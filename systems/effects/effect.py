class StatusEffect:
    def __init__(self, name, duration, damage=0, defense_bonus=0, attack_bonus=0, max_mana_bonus=0, max_health_bonus=0, ):
        self.name = name
...
BUFF = StatusEffect("Buff", duration=3, attack_bonus=5, max_mana_bonus=100)
